...
# Provide a simple API to fetch the latest statistics so all browsers can stay
# in sync.
    ...
    return jsonify(
        {
            ...
            "krystian_this_month": monthly.get("krystian", 0),
            "jensen_this_month": monthly.get("jensen", 0),
            "most_in_a_day": stats.get("daily_max", {}).get("count", 0),
        }
    )
